    ...
    public static Map<String, String> getAllAvailableTZAndFlags() {
        ...
        supportedJVMZoneIds.stream().forEach(jvmZoneId -> {
            if (!zoneIdAndFlag.containsKey(jvmZoneId)) {
                ...
                switch (jvmZoneId) {
                    case "Africa/Asmara":
                        zoneIdAndFlag.put(jvmZoneId, "er");
                        break;
                    case "Africa/Juba":
                        zoneIdAndFlag.put(jvmZoneId, "ss");
                        break;
                    ...
                    case "America/Curacao":
                        zoneIdAndFlag.put(jvmZoneId, "cw");
                        break;
                    ...
                    case "America/Knox_IN":
                        zoneIdAndFlag.put(jvmZoneId, "xx");
                        break;
                    case "America/Kralendijk":
                        zoneIdAndFlag.put(jvmZoneId, "bq");
                        break;
                    case "America/Lower_Princes":
                        zoneIdAndFlag.put(jvmZoneId, "sx");
                        break;
                    case "America/Marigot":
                        zoneIdAndFlag.put(jvmZoneId, "mf");
                        break;
                    ...
                    case "America/Moncton":
                        ...
                        break;
                    case "America/Nuuk":
                        zoneIdAndFlag.put(jvmZoneId, "gl");
                        break;
                    ...
                    case "America/St_Barthelemy":
                        zoneIdAndFlag.put(jvmZoneId, "bl");
                        break;
                    ...
                    case "Antarctica/South_Pole":
                        zoneIdAndFlag.put(jvmZoneId, "aq");
                        break;
                    case "Antarctica/Troll":
                        zoneIdAndFlag.put(jvmZoneId, "aq");
                        break;
                    case "Asia/Atyrau":
                        zoneIdAndFlag.put(jvmZoneId, "kz");
                        break;
                    case "Asia/Barnaul":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Asia/Chita":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Asia/Famagusta":
                        zoneIdAndFlag.put(jvmZoneId, "cy");
                        break;
                    case "Asia/Hebron":
                        zoneIdAndFlag.put(jvmZoneId, "ps");
                        break;
                    case "Asia/Ho_Chi_Minh":
                        zoneIdAndFlag.put(jvmZoneId, "vn");
                        break;
                    case "Asia/Kathmandu":
                        zoneIdAndFlag.put(jvmZoneId, "np");
                        break;
                    case "Asia/Khandyga":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Asia/Kolkata":
                        zoneIdAndFlag.put(jvmZoneId, "in");
                        break;
                    case "Asia/Macao":
                        zoneIdAndFlag.put(jvmZoneId, "mo");
                        break;
                    ...
                    case "Asia/Srednekolymsk":
                        ...
                        break;
                    case "Asia/Tel_Aviv":
                        zoneIdAndFlag.put(jvmZoneId, "il");
                        break;
                    case "Asia/Tomsk":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Asia/Ust-Nera":
                        ...
                        break;
                    case "Asia/Yangon":
                        zoneIdAndFlag.put(jvmZoneId, "mm");
                        break;
                    case "Atlantic/Faroe":
                        zoneIdAndFlag.put(jvmZoneId, "fo");
                        break;
                    case "Europe/Astrakhan":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Europe/Belgrade":
                        zoneIdAndFlag.put(jvmZoneId, "rs");
                        break;
                    case "Europe/Busingen":
                        zoneIdAndFlag.put(jvmZoneId, "de");
                        break;
                    case "Europe/Guernsey":
                        zoneIdAndFlag.put(jvmZoneId, "gg");
                        break;
                    case "Europe/Isle_of_Man":
                        zoneIdAndFlag.put(jvmZoneId, "im");
                        break;
                    case "Europe/Jersey":
                        zoneIdAndFlag.put(jvmZoneId, "je");
                        break;
                    case "Europe/Kirov":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    case "Europe/Mariehamn":
                        zoneIdAndFlag.put(jvmZoneId, "ax");
                        break;
                    case "Europe/Podgorica":
                        zoneIdAndFlag.put(jvmZoneId, "me");
                        break;
                    case "Europe/Saratov":
                        zoneIdAndFlag.put(jvmZoneId, "ru");
                        break;
                    ...
                    case "Pacific/Bougainville":
                        zoneIdAndFlag.put(jvmZoneId, "pg");
                        break;
                    case "Pacific/Chuuk":
                        zoneIdAndFlag.put(jvmZoneId, "fm");
                        break;
                    case "Pacific/Kanton":
                        zoneIdAndFlag.put(jvmZoneId, "ki");
                        break;
